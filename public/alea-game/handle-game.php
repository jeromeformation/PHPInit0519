...
// Création du message de renvoi à l'utilisateur
$resultMessage = "";
...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    if (!array_key_exists('letter', $_POST) || $_POST['letter'] === '') {
        ...
        $resultMessage = "Vous avez dépassé votre nombre d'essais, le jeu est fini ! On recommence !";
        // Recommencer le jeu (on vide TOUTES les variables de la session)
        session_unset();
    } else {
        // S'il n'a pas gagné => il a perdu !
        $resultMessage = "La lettre saisie est mauvaise, vous pouvez réessayer !";
